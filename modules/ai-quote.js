(function (window, document) {
  ...
  var translations = {
    cs: {
      ...
      formEyebrow: 'Podklady k projektu',
    ...
    '<div class="larx-ai-quote">',
      ...
      '<section class="larx-ai-quote__form-card" aria-labelledby="larx-ai-form-title">',
        '<div class="larx-ai-quote__form-heading">',
          '<p class="larx-ai-quote__eyebrow">' + copy.formEyebrow + '</p>',
          '<h2 id="larx-ai-form-title">' + copy.formTitle + '</h2>',
        '</div>',
